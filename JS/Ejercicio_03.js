...
/*console.log("%c1000.- Reto", style_console);
let spotifyUser={
    Name:"Gato Gordo", //Congelado
    nickname: "gatr0z", //Sellado
    email: "ganx0@gato.com", //Sellado
    password: "miausito123", //Sellado
    rol: "Premium", //Sellado
    since: "23/03/2023", //Congelado
    playList: ["Para lavar trastes", "Tristes", "Para hacer ejercicio"] //Normal
}
console.log("Los datos actuales del usuario de Spotify:")
console.table(spotifyUser);

Object.defineProperty(spotifyUser, {
    Name: {
        value: "Gato Gordo",
        writeable: false,
        configurable: false
...
//Se intenta modificar las propiedades del objeto que se encuentran selladas
spotifyUser.password="gatuno987"

//Se comprueba si se ha modificado la propiedad en el Objeto
console.table(spotifyUser);

//Se intenta modificar las propiedades del Objeto que se encuentran bloqueadas
spotifyUser.Name="Gatuno Gorduno";

//Se comprueba si se ha vuelto a modificar la propiedad del Objeto
console.table(spotifyUser);*/