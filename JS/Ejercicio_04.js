...
console.log("%c6.- Agregar un nuevo elemento a un arreglo (UNISHIFT) en la posición inicial.", style_console);
...
console.log("%c13.- Reducción de Elementos de un arreglo - REDUCE", style_console);
